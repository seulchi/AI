...
def vit_base(patch_size=16, num_register_tokens=0, in_chans=3, **kwargs):
    model = DinoVisionTransformer(
        patch_size=patch_size,
        embed_dim=768,
        depth=12,
...
def vit_large(patch_size=16, num_register_tokens=0, in_chans=3, **kwargs):
    model = DinoVisionTransformer(
        patch_size=patch_size,
        embed_dim=1024,
        depth=24,
...
def vit_giant2(patch_size=16, num_register_tokens=0, in_chans=3, **kwargs):
    """
